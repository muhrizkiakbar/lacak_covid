class LSix::FOutTownDestsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @l_six_f_out_town_dest.save
        format.html { redirect_to l_six_first_path(@l_six_first), notice: 'F out town dest was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @l_six_f_out_town_dest.update(l_six_f_out_town_dest_params)
        format.html { redirect_to l_six_first_path(@l_six_first), notice: 'F out town dest was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to l_six_first_path(@l_six_first), notice: 'F out town dest was successfully destroyed.' }
