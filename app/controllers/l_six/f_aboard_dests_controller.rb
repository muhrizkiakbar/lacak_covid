class LSix::FAboardDestsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @l_six_f_aboard_dest.save
        format.html { redirect_to l_six_first_second_third_fourth_path(@l_six_first,@l_six_second,@l_six_third,@l_six_fourth), notice: 'F aboard dest was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @l_six_f_aboard_dest.update(l_six_f_aboard_dest_params)
        format.html { redirect_to l_six_first_second_third_fourth_path(@l_six_first,@l_six_second,@l_six_third,@l_six_fourth), notice: 'F aboard dest was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to l_six_first_second_third_fourth_path(@l_six_first,@l_six_second,@l_six_third,@l_six_fourth), notice: 'F aboard dest was successfully destroyed.' }
