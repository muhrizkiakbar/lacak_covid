class LSix::FHospitalDestsController < ApplicationController
  ...
  def new
    ...
    authorize @l_six_f_hospital_dest
  end
  ...
  def create
    ...
    respond_to do |format|
      if @l_six_f_hospital_dest.save
        format.html { redirect_to l_six_first_second_third_fourths_path(@l_six_first,@l_six_second,@l_six_third), notice: 'F hospital dest was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @l_six_f_hospital_dest.update(l_six_f_hospital_dest_params)
        format.html { redirect_to l_six_first_second_third_fourths_path(@l_six_first,@l_six_second,@l_six_third), notice: 'F hospital dest was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to l_six_first_second_third_fourths_path(@l_six_first,@l_six_second,@l_six_third), notice: 'F hospital dest was successfully destroyed.' }
