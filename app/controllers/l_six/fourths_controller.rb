  ...
  def create
    ...
    respond_to do |format|
      if @l_six_fourth.save
        format.html { redirect_to l_six_first_second_third_fourth_path(@l_six_first,@l_six_second,@l_six_third,@l_six_fourth), notice: 'Fourth was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @l_six_fourth.update(l_six_fourth_params)
        format.html { redirect_to l_six_first_second_third_fourth_path(@l_six_first,@l_six_second,@l_six_third,@l_six_fourth), notice: 'Fourth was successfully updated.' }
