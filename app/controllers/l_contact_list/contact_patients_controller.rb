class LContactList::ContactPatientsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @l_contact_list_contact_patient.save
        format.html { redirect_to main_patient_contact_patients_path(@main_patient,@l_contact_list_contact_list), notice: 'Contact patient was successfully created.' }
  ...
  def update
    respond_to do |format|
      ...
      if @l_contact_list_contact_patient.update(l_contact_list_contact_patient_params)
        format.html { redirect_to main_patient_contact_patients_path(@main_patient,@l_contact_list_contact_list), notice: 'Contact patient was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to l_contact_list_contact_list_contact_list_path(@l_contact_list_contact_list), notice: 'Contact patient was successfully destroyed.' }
