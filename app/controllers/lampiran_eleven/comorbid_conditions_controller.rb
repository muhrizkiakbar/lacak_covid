class LampiranEleven::ComorbidConditionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @lampiran_eleven_comorbid_condition.save
        format.html { redirect_to @lampiran_eleven_comorbid_condition, notice: 'Comorbid condition was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @lampiran_eleven_comorbid_condition.update(lampiran_eleven_comorbid_condition_params)
        format.html { redirect_to @lampiran_eleven_comorbid_condition, notice: 'Comorbid condition was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to lampiran_eleven_comorbid_conditions_url, notice: 'Comorbid condition was successfully destroyed.' }
  ...
  private
    ...
    def set_lampiran_eleven_comorbid_condition
      @lampiran_eleven_comorbid_condition = LampiranEleven::ComorbidCondition.find(params[:id])
    end

    # Only allow a list of trusted parameters through.
    def lampiran_eleven_comorbid_condition_params
      params.require(:lampiran_eleven_comorbid_condition).permit(:lampiran_eleven_close_contact_information_id, :is_cancer, :is_diabetes, :is_ppok, :is_hiv, :is_liver, :is_obesity, :is_asthma, :is_blood_disorder, :is_heart_disease, :is_kidney, :is_neurology, :is_organ_donor_recipient, :is_pregnant, :is_first_semester_pregnant, :is_second_semester_pregnant, :is_third_semester_pregnant, :estimated_birth, :is_influenza_vaccine, :date_of_influenza_vaccine, :influenza_vaccine_in_the_country, :is_pvc_vaccine, :date_of_pvc_vaccine)
    end
end
