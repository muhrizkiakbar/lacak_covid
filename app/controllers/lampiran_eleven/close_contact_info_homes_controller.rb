  ...
  def create
    ...
    respond_to do |format|
      if @lampiran_eleven_close_contact_info_home.save
        format.html { redirect_to new_lampiran_eleven_close_contact_information_info_exposes_officer_path(@lampiran_eleven_close_contact_information), notice: 'Close contact info home was successfully created.' }
