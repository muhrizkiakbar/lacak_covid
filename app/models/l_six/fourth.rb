...
class LSix::Fourth < ApplicationRecord
  ...
  has_many :ls_f_aboard_dests, class_name: 'LSix::FAboardDest', foreign_key: :l_six_four_id, dependent: :destroy
  has_many :ls_f_animal_dests, class_name: 'LSix::FAnimalDest', foreign_key: :l_six_four_id, dependent: :destroy
  has_many :ls_f_hospital_dests, class_name: 'LSix::FHospitalDest', foreign_key: :l_six_four_id, dependent: :destroy
  has_many :ls_f_out_town_dests, class_name: 'LSix::FOutTownDest', foreign_key: :l_six_four_id, dependent: :destroy
  has_many :ls_f_pdp_dests, class_name: 'LSix::FPdPDest', foreign_key: :l_six_four_id, dependent: :destroy
  has_many :ls_f_positive_dests, class_name: 'LSix::FPositiveDest', foreign_key: :l_six_four_id, dependent: :destroy
