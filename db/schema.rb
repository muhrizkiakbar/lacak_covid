...
ActiveRecord::Schema.define(version: 2020_05_27_162115) do
  ...
  create_table "roles", force: :cascade do |t|
    ...
    t.boolean "is_surveilance"
    t.boolean "is_public_health_center"
    t.boolean "is_dinkes_region"
    t.boolean "is_dinkes_province"
